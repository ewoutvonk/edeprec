...
Capistrano::Configuration.instance(:must_exist).load do 
  namespace :lucid do
    namespace :rvm do
      ...
      RVM_UBUNTU_LUCID_DEPS = {
        :mri_ree => %w(libreadline6 libreadline6-dev libxslt-dev libyaml-dev),
      }
      ...
      task :install_deps do
        apt.install( {:base => convert_rubies_to_deps(RVM_UBUNTU_DEPS, RVM_UBUNTU_LUCID_DEPS) }, :stable )
      end
